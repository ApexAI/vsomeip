...
http_archive(
    name = "boost",
    urls = ["https://deac-riga.dl.sourceforge.net/project/boost/boost/{version_underscore}/boost_{version}.tar.bz2".format(version = BOOST_VERSION, version_underscore = BOOST_VERSION.replace(".", "_"))],
    strip_prefix = "boost_{version_underscore}".format(version_underscore = BOOST_VERSION.replace(".", "_")),
